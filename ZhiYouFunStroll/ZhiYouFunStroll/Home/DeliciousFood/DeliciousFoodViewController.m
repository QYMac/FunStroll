...
@interface DeliciousFoodViewController ()<GeneralWaterfallFlowLayoutDelegate,UICollectionViewDelegate,UICollectionViewDataSource>
...
- (void)MJRefreshFooter{
    // 上拉刷新
    self.deliciousFoodCollectionView.mj_footer = [MJRefreshAutoNormalFooter footerWithRefreshingBlock:^{
        //停止刷新
