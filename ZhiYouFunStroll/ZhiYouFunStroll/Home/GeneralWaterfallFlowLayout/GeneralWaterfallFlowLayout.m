...
static const NSInteger General_Columns_ = 3;
static const CGFloat General_XMargin_ = 10;
static const CGFloat General_YMargin_ = 10;
static const UIEdgeInsets General_EdgeInsets_ = {20, 10, 10, 10};

@interface GeneralWaterfallFlowLayout()
...
- (UIEdgeInsets)edgeInsets
{
    ...
    {
        return General_EdgeInsets_;
    }
}

- (id<GeneralWaterfallFlowLayoutDelegate>)delegate
{
    return (id<GeneralWaterfallFlowLayoutDelegate>)self.collectionView.dataSource;
}
