...
- (void)saveUserInfoData:(NSDictionary *)dict grant_type:(NSString *)grant_type{
    ...
    [AFNetworkingManage LoginSearchUserId:user_id success:^(id  _Nonnull responseObject) {
        ...
        [UserModel saveObject:nickname forKey:kNickname];
        [UserModel saveObject:avatar forKey:kAvatar];
        [UserModel saveObject:gender forKey:kGender];
        [UserModel saveObject:age forKey:kAge];
        [UserModel saveObject:bio forKey:kBio];
        [UserModel saveObject:bgUrl forKey:kBgUrl];
        [UserModel saveObject:ipLocation forKey:kIpLocation];
