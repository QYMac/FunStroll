...
+ (void)LoginMobile:(NSString *)mobile success:(SuccessHandler)success failureHandler:(FailureHandler)failure{
    ...
    [self requestWithUrl:url params:@{} requestType:@"GET" isBody:NO successHanler:success failureHandler:failure];
}
...
+ (void)LoginIsSetPasswordSuccess:(SuccessHandler)success failureHandler:(FailureHandler)failure{
    ...
    [self requestWithUrl:url params:parameters requestType:@"GET" isBody:YES successHanler:success failureHandler:failure];
}
